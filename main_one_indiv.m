...
valid_indiv = [1, 0, 0, 1, 1, 1]; %[I1, I2, I3, I4, I5, I6];

%OPCOES DE BANCO TREINAMENTO
opt_tr = 1;                         %1-Usa tr_per; 2-Usa tr_indiv; 3-Usa arquivos 'M' p/ validacao
...
fid = fopen('ResultsFilt750_One_Indiv_Freq4-35_Baseline2.txt','w+');
h = 1;
for t = find(valid_indiv == 1)
    use_indiv = zeros(size(valid_indiv));
    use_indiv(t) = 1;
